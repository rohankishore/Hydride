...
def create_new_default_project():
    ...
    add_project(db_path="../resources/data/db/study_projects.db", project_name="New Default Project")
...
def fetch_project_completion(project_id):
    try:
        conn = sqlite3.connect("../resources/data/db/study_projects.db")
        cursor = conn.cursor()
...
class CardButtonDialog(QDialog):
    def __init__(self, image_path: None, button_text: None, parent=None):
        ...
        jee_pixmap = QPixmap("../resources/icons/icon/NTA.png")
        ...
        def_pixmap = QPixmap("../resources/icons/icon/default.png")
...
class ProjectsWidget(QWidget):
    ...
    def template_card(self):
        temp_dialog = CardButtonDialog(image_path="../resources/icons/icon/NTA.png", button_text="JEE")
        temp_dialog.exec()
