...
class PomodoroTimer(QWidget):
    ...
    def init_db(self):
        ...
        self.conn = sqlite3.connect('../resources/data/db/focus_data.db')
    ...
    def init_ui(self):
        ...
        start_icon = QIcon("../resources/icons/icon/start.png")
        ...
        reset_icon = QIcon("../resources/icons/icon/stop.png")
