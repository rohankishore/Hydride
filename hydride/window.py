...
def initialize_database():
    connection = sqlite3.connect("../resources/data/db/tasks.db")
...
def initialize_study_db():
    ...
    DB_PATH = "../resources/data/db/study_projects.db"
...
def initialize_study_db():
    connection = sqlite3.connect("../resources/data/db/study_projects.db")
    cursor = connection.cursor()
...
class Window(FramelessWindow):
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.focusInterface, QIcon("../resources/icons/icon/focus.png"), 'Focus', selectedIcon=QIcon(
            "../resources/icons/icon/focus.png"))
